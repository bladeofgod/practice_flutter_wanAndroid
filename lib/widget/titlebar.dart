...
class TitleBar extends StatefulWidget implements PreferredSizeWidget{
  ...
  TitleBar({this.leftButton,this.isShowBack = true,this.title,this.rightButtons});
        ...
        children: <Widget>[
          Offstage(
            ...
            child: Container(
              ...
              child: widget.leftButton == null ? IconButton(
          ...
          Positioned(
            ...
            child: Container(
              ...
              Row(children: widget.rightButtons,):null,
            ),
          )
        ],
      ),
